...
function buildKPIs(records) {
  ...
  document.getElementById("kpi-row").innerHTML = `
    ...
    <div class="kpi"><div class="label">Datenstand</div><div class="value" style="font-size:1.2rem">${formatUpdateTimestamp(latestUpdate)}</div><div class="sub">letztes Update</div></div>
  `;
}
